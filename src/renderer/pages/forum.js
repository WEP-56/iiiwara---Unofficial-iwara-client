...
function forumComposerHtml(ctx,cats){
  ...
  return `<div class="create-page" style="padding:18px 0"><div class="create-title">发布帖子</div><div class="create-sub" style="margin-top:6px">选择分类后发布到论坛</div><div style="margin-top:12px"><select class="detail-select" id="forumPostCategory" style="width:100%;height:36px">${opts}</select></div><div class="create-input-box" style="margin-top:10px"><input id="forumPostTitle" placeholder="标题"${canSend?'':' disabled'} style="width:100%;height:40px;padding:0 12px;background:var(--bg-2);border:1px solid var(--b1);border-radius:var(--r-sm);color:var(--t0);font-size:13px;outline:none"></div><div class="create-textarea-box" style="margin-top:10px"><textarea id="forumPostBody" placeholder="${canSend?'内容':'登录后可发帖'}" style="width:100%;min-height:180px;padding:12px;background:var(--bg-2);border:1px solid var(--b1);border-radius:var(--r-sm);color:var(--t0);font-size:13px;line-height:1.6;resize:vertical;outline:none"${canSend?'':' disabled'}></textarea></div><div id="forumPostErr" style="margin-top:10px;font-size:12px;color:#f87171;min-height:16px"></div><div style="display:flex;gap:10px"><button class="create-btn" id="forumPostCancelBtn" style="flex:1;background:rgba(255,255,255,.08);border:1px solid var(--b0);color:var(--t1)">取消</button><button class="create-btn" id="forumPostSendBtn" style="flex:1"${canSend?'':' disabled'}>发布</button></div></div>`
}
